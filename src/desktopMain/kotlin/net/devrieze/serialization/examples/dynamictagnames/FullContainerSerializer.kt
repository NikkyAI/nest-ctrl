...
//import xml.DynamicTagReader
//import xml.DynamicTagWriter
//
///**
// * A common base class that contains the actual code needed to serialize/deserialize the container.
// */
//@Deprecated("")
//class FullContainerSerializer : XmlSerializer<TestContainer> {
...
//                            val filter = DynamicTagReader(input, elementXmlDescriptor, "Test_")
//
...
//            }
//        }
//        return TestContainer(dataList)
//    }
//
//    override fun serializeXML(encoder: Encoder, output: XmlWriter, value: TestContainer, isValueChild: Boolean) {
//        val xml =
...
//                val writer = DynamicTagWriter(output, elementXmlDescriptor, element.index.toString(), "Test_")
//
